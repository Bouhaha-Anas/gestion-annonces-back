...
public class SecurityConfig extends WebSecurityConfigurerAdapter
{
	...
	protected void configure(HttpSecurity http) throws Exception 
	{
		http
			...
			.antMatchers("/accueil/resultatRecherche").permitAll()
			.antMatchers("/profilClient", "profilClient/mesMassages","profilClient/parametresGeneraux","profilClient/mesCommandes", "profilClient/mesRecommandations").hasAnyAuthority("CLIENT")
